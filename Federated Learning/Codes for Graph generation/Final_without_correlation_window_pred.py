...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 19 09:05:29 2021
...
np.savetxt("global_loss_withoutcorrelation_window_50_prediction_5.csv", global_loss)  
torch.save(global_model,"GLOBALMODELNEWONE_withoutCorrelationwindow_50_prediction_5.pt" ) 
...
np.savetxt("global_loss_withoutcorrelation_window_60_prediction_4.csv", global_loss)  
torch.save(global_model,"GLOBALMODELNEWONE_withoutCorrelationwindow_60_prediction_4.pt" ) 
...
np.savetxt("global_loss_withoutcorrelation_window_65_prediction_6.csv", global_loss)  
torch.save(global_model,"GLOBALMODELNEWONE_withoutCorrelationwindow_65_prediction_6.pt" ) 
'''
...
np.savetxt("global_loss_withoutcorrelation_window_80_prediction_5.csv", global_loss)  
torch.save(global_model,"GLOBALMODELNEWONE_withoutCorrelationwindow_80_prediction_5.pt" ) 
...
plt.savefig('FedAvgCorr_Loss_vs_Communicationrounds_withoutcorrelation_window_pred_NEWONE.png') 
